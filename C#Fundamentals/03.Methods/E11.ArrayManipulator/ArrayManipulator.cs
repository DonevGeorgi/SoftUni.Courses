    ...
    class ArrayManipulator
    {
        static void Main(string[] args)
        {
            ...
            while ((input = Console.ReadLine()) != "end")
            {
                ...
                else if (inputArgs[0] == "max")
                {
                    PrintTheIndexOfTheMaxOddOrEvenNumberInArray(numbers, inputArgs[1]);
                }
                else if (inputArgs[0] == "min")
                {
                    PrintTheIndexOfTheMinOddOrEvenNumberInArray(numbers, inputArgs[1]);
                }
                else if (inputArgs[0] == "first")
                {
                    PrintTheFirstNOddOrEvenNumbersInArray(numbers, int.Parse(inputArgs[1]), inputArgs[2]);
                }
                else if (inputArgs[0] == "last")
                {
                    PrintTheLastNOddOrEvenNumbersInArray(numbers, int.Parse(inputArgs[1]), inputArgs[2]);
                }
            }
