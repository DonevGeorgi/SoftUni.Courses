...
namespace StockMarket
{
    public class Stock
    {
        public Stock(string companyName, string director, decimal pricePerShares
            , int totalNumberPerShares)
        {
            CompanyName = companyName;
            Director = director;
            PricePerShare = pricePerShares;
            TotalNumberOfShares = totalNumberPerShares;
